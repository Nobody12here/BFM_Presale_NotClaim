...
const Banner = () => {
  ...
  async function init() {
    try {
        ...
        readContracts({
          contracts: [
            ...
            },
            {
              ...
              functionName: "presalePhases",
              args: [
                Number(phase) === 2 ? phase : (Number(phase) + 1).toString(),
              ],
            },
          ],
        }),
      ...
      setNextPrice(+parseFloat(1 / +formatUnits(nexttokenPrice, 8)).toFixed(5));
      setTotalSupply(formatUnits(value, decimals));
      setTokenSold(parseFloat(formatUnits(totalSold, decimals)).toFixed(2));
      setbnbToToken(+parseFloat(formatUnits(bnbToTokens, decimals)).toFixed(2));
      settotalTokens(
      ...
      setCurrentPrice(+parseFloat(1 / +formatUnits(tokenPrice, 8)).toFixed(5));
          ...
          <div className="col-lg-6">
            <div className="gittu-banner-left">
              ...
              <ul className="gittu-banner-list">
                ...
                <li>Minimun Token Purchase: 2000 BFM</li>
                  ...
                  {isBuyNow ? (
                    ...
                    <div className="card-content">
                      ...
                      <div className="mt-1 mb-17">
                        <DownCounter init={init} stageEnd={stageEnd} />
                      </div>

                      <div className="mb-15">
                        <Progressbar done={Number(tokenPercent).toFixed(0)} />
                      </div>

                      <div className="presale-raised fw-500 mb-25">
                        <p className="fs-15 text-white">Raised: {tokenSold}</p>
                        <p className="fs-15 text-white">Goal: {totalTokens}</p>
                      </div>
                      ...
                      <div className="mb-35">
                        <TokenInfoWrapper>
                          ...
                          <li>
                            <p> Stage End</p>
                            <p>{moment(stageEnd).format("lll")}</p>
                          </li>
                        </TokenInfoWrapper>
                      </div>
